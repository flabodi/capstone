  ...
  return (
    <>
      ...
      <Row className="home-row ">
        ...
        >
          <h2 className="mx-5">
            Abbiamo preso le ricette dei grandi classici e le abbiamo vestite a
            festa.
          </h2>
          <p className="mx-5 mt-4 imb-font ">
          ...
          <a className="ms-5 text-decoration-none " href="">CHI SIAMO</a>
        </Col>
        <Col md={7}>
